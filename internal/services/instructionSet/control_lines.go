...
const (
	...
	CL_FLG2 // Secondary flags registry
...
var (
	mnemonics = []string{
		...
		/* EPROM 1b */  "ALD0", "ALD1", "ALD2", "DBRW", "FLG2", "PCIN", "PCLL", "PCLH",
	...
	lineDescriptions = []string{
		...
		"Secondary flags registry enabled",
	...
	x = uint64(
		CL_AHD0 | CL_AHC0 | CL_AHC1 | CL_DBD1 | CL_DBD2 | CL_PCLH | CL_PCLL |
		CL_DBRW | CL_PCIN | CL_ALD0 | CL_ALD1 | CL_ALD2 | CL_CRST | CL_ALC0 |
		CL_ALC1 | CL_ALC2 | CL_SPLD | CL_ALLD | CL_AHLD | CL_AUS1 | CL_AULA |
		CL_AULB | CL_AUS2 | CL_SBD2 | CL_SBD1 | CL_SBD0 | CL_SBLX | CL_SBLY | CL_SBLA)
